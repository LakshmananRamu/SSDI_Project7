...
<input class="btn btn-info center-block " type= "submit" value="CS application">
</form>
<% }%>
...
<input  class="btn btn-info center-block " type= "submit" value="ME application">
</form>
<% }%>
...
<input class="btn btn-info center-block " type= "submit" value="EE application">
</form>
<% }%>
 </div>
 </body>
