  ...
  <div class='container'>
    <div class='panel panel-primary dialog-panel'>
      <div class='panel-heading'>
        <h5>Mechanical Engineering-Student Vacancies and Cutoff</h5>
      </div>
          ...
          <div class='form-group'>
            <div class='col-md-8'>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='studentvacancies' placeholder='Student Vacancies' name=Student Vacancies type='number'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
            ...
            <div class='col-md-offset-4 col-md-3'>
              <button class='btn-lg btn-primary' type='submit' name='application' value="ME Student Vacancies">Create Vacancies</button>
            </div>
            <div class='col-md-3'>
