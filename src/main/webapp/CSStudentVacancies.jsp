  ...
  <div class='container'>
    <div class='panel panel-primary dialog-panel'>
      <div class='panel-heading'>
        <h5>Computer Science-Student Vacancies and Cutoff</h5>
      </div>
          ...
          <div class='form-group'>
            ...
            <div class='col-md-offset-4 col-md-3'>
              <button class='btn-lg btn-primary' type='submit' name='studentvacancies' value="CS Student Vacancies">Create Vacancies</button>
            </div>
            <div class='col-md-3'>
